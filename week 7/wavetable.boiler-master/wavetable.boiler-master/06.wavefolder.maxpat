...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 298.0, 35.0, 150.0, 48.0 ],
					"text" : "dial verändern: mehr oder weniger distortion bei abgespieltem sample"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 478.0, 275.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 333.0, 256.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 257.5, 243.052325581395394, 38.0, 22.0 ],
					"text" : "*~ -1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 661.0, 330.0, 61.0, 20.0 ],
					"text" : "number~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 596.0, 330.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 539.0, 282.0, 36.0, 22.0 ],
					"text" : "!/~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 186.0, 45.0, 22.0 ],
					"text" : "$1 150"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 455.0, 221.052325581395394, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 455.0, 151.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 116.0, 147.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 521.0, 28.0, 150.0, 75.0 ],
					"text" : "live.dial\nunit style: float\nrange/enum: 0. 999.\nexponent: 0.25\n-->change im Inspector"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 455.0, 35.0, 41.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.0, 513.0, 87.0, 20.0 ],
					"text" : "spectroscope~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.0, 540.0, 247.0, 73.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 49.0, 495.0, 52.0, 136.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 139.0, 671.0, 72.0, 22.0 ],
					"text" : "send~ out2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 671.0, 72.0, 22.0 ],
					"text" : "send~ out1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 60.0, 373.0, 498.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 60.0, 303.0, 414.0, 22.0 ],
					"text" : "pong~ 0 0. 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 60.0, 81.0, 74.0, 22.0 ],
					"text" : "receive~ in1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 910.370370370370438, 67.0, 367.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 910.370370370370438, 109.0, 331.370370370370438, 156.052325581395394 ],
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Desktop/Sound Synthesis MaxMSP/week 7/wavetable.boiler-master/wavetable.boiler-master",
				"patcherrelativepath" : ".",
				"type" : "PNG",
				"implicit" : 1
			}
