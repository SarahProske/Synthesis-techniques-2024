...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 440.0, 81.0, 89.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 440.0, 38.0, 69.0, 22.0 ],
									"text" : "r debounce"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 43.0, 218.0, 149.5, 22.0 ],
									"text" : "gate 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 304.0, 165.0, 29.5, 22.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 304.0, 125.0, 67.0, 22.0 ],
									"text" : "delay 1000"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 43.0, 75.0, 280.0, 22.0 ],
									"text" : "t 0 b b"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 449.5, 204.0, 52.5, 204.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
,
					"patching_rect" : [ 138.0, 340.0, 71.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 406.0, 124.5, 96.0, 131.0 ],
					"text" : "rewind to event:\n(wenn Eventnumbers in piece, dann schnell navigieren, auswählen, counter button clicken)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 406.0, 297.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 512.0, 260.0, 66.0, 20.0 ],
					"text" : "live.menu"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 406.0, 260.0, 100.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.0, 568.0, 88.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 208.0, 177.0, 150.0, 62.0 ],
					"text" : "98 ist Pedal\n32 Leertaste\n28 <\n29 >"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 299.0, 292.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 244.5, 291.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 244.5, 329.0, 29.5, 22.0 ],
					"text" : "dec"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.0, 329.0, 29.5, 22.0 ],
					"text" : "inc"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 138.0, 522.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 138.0, 483.0, 555.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 138.0, 293.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 138.0, 253.0, 232.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 138.0, 183.0, 50.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 714.0, 240.0, 101.0, 34.0 ],
					"text" : "Panic klicken, dann output aus"
				}

			}
, 			{
				"box" : 				{
					"fontsize" : 26.47987349445798,
					"id" : "obj-7",
					"maxclass" : "message",
					"numinlets" : 2,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 606.0, 240.0, 95.0, 39.0 ],
					"text" : "PANIC!"
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.72156862745098, 0.152941176470588, 0.152941176470588, 1.0 ],
					"id" : "obj-16",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 606.0, 333.0, 47.0, 22.0 ],
					"text" : "s panic"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 588.5, 77.0, 201.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 588.5, 139.0, 173.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 601.083336929480311, 405.0, 244.0, 75.0 ],
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"color" : [ 0.741176470588235, 0.050980392156863, 0.07843137254902, 1.0 ],
									"id" : "obj-30",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 510.0, 530.0, 80.0, 22.0 ],
									"text" : "send channel"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 321.0, 283.0, 150.0, 34.0 ],
									"text" : "strg d --> Objekt verdoppeln"
								}

							}
, 							{
								"box" : 								{
									"color" : [ 0.090196078431373, 0.498039215686275, 0.647058823529412, 1.0 ],
									"id" : "obj-27",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 321.0, 530.0, 78.0, 22.0 ],
									"text" : "send velocity"
								}
...
, 							{
								"box" : 								{
									"color" : [ 0.129411764705882, 0.776470588235294, 0.325490196078431, 1.0 ],
									"id" : "obj-25",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 131.0, 530.0, 63.0, 22.0 ],
									"text" : "send pitch"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 565.0, 476.0, 79.0, 20.0 ],
									"text" : "MIDI channel"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 382.0, 477.0, 106.0, 34.0 ],
									"text" : "MIDI velocity (like amplitude)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 192.0, 476.0, 109.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 510.0, 476.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 321.0, 477.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 131.0, 477.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 90.0, 477.0, 18.0, 20.0 ],
									"text" : "i"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 131.0, 436.0, 398.0, 22.0 ],
									"text" : "notein"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 34.0, 385.0, 48.0, 20.0 ],
									"text" : "umenu"
								}
...
, 							{
								"box" : 								{
									"id" : "obj-7",
									"items" : [ "loopMIDI Port", ",", "loopMIDI Port 1" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 90.0, 384.0, 100.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 90.0, 294.0, 64.0, 22.0 ],
									"text" : "controllers"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 90.0, 251.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 31.0, 277.0, 29.5, 22.0 ],
									"text" : "128"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 48.0, 84.0, 150.0, 34.0 ],
									"text" : "r panic: bei feedback panic stoppt sound"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 48.0, 131.0, 45.0, 22.0 ],
									"text" : "r panic"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 98.0, 170.0, 150.0, 34.0 ],
									"text" : "Doppelklick, dann gehen slider hoch"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 329.0, 498.5, 47.0, 20.0 ],
									"text" : "ezdac"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 273.0, 498.5, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 437.0, 284.0, 5.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 367.0, 284.0, 5.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 315.0, 284.0, 5.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 242.0, 284.0, 5.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 388.0, 277.0, 22.0, 140.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 273.0, 277.0, 22.0, 140.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 350.0, 213.0, 81.0, 22.0 ],
									"text" : "receive~ out2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 248.0, 213.0, 81.0, 22.0 ],
									"text" : "receive~ out1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 98.0, 260.0, 20.0, 140.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 98.0, 213.0, 83.0, 22.0 ],
									"text" : "loadmess 128"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 814.0, 277.0, 113.0, 34.0 ],
									"text" : "slider to scale input volume"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 829.0, 57.0, 98.0, 34.0 ],
									"text" : "=multiple inputs (microphones"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 742.5, 57.0, 75.0, 22.0 ],
									"text" : "adc~ 1 2 3 4"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 754.800005888938813, 446.0, 61.0, 22.0 ],
									"text" : "send~ in2"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 754.800005888938813, 277.0, 22.0, 140.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 797.700005888938904, 297.0, 5.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 736.700005888938904, 294.0, 5.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 789.0, 164.0, 150.0, 48.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 728.0, 131.0, 104.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 631.700005888938904, 446.0, 61.0, 22.0 ],
									"text" : "send~ in1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 631.700005888938904, 277.0, 22.0, 140.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 673.700005888938904, 294.0, 5.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 610.700005888938904, 294.0, 5.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1242.700005888938904, 417.0, 66.0, 20.0 ],
									"text" : "live.meter"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1175.700005888938904, 354.0, 40.0, 20.0 ],
									"text" : "gain"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1140.700005888938904, 294.0, 44.0, 20.0 ],
									"text" : "slider"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 1203.700005888938904, 394.0, 5.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 1140.700005888938904, 340.0, 22.0, 140.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 1098.700005888938904, 294.0, 20.0, 140.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 972.200005888938904, 186.0, 43.0, 22.0 ],
									"text" : "+~ 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 972.200005888938904, 148.0, 44.0, 22.0 ],
									"text" : "noise~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 610.700005888938904, 218.0, 624.5, 22.0 ],
									"text" : "selector~ 5"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 610.700005888938904, 143.0, 57.0, 20.0 ],
									"text" : "umneu"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 610.700005888938904, 173.0, 100.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 731.800005888938927, 186.0, 45.0, 22.0 ],
									"text" : "adc~ 1"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 326.0, 178.0, 188.0, 50.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 326.0, 133.0, 61.0, 22.0 ],
													"text" : "del 15000"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 533.5, 125.0, 228.0, 64.0 ],
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 18.0, 70.0, 635.5, 22.0 ],
													"text" : "b 3"
												}
...
,
									"patching_rect" : [ 620.545454545454504, 247.0, 25.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 326.0, 178.0, 172.0, 64.0 ],
													"text" : ";\r\nping.hi.ms 200;\r\nping.low.ms 50;\r\nprinter.thingy \"Fade complete.\""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 326.0, 133.0, 55.0, 22.0 ],
													"text" : "del 6000"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 539.5, 124.0, 224.5, 105.0 ],
...
,
									"patching_rect" : [ 521.545454545454504, 247.0, 25.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 326.0, 178.0, 185.0, 50.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 539.5, 124.0, 224.0, 64.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 576.5, 126.0, 224.0, 77.0 ],
...
,
									"patching_rect" : [ 323.272727272727252, 247.0, 25.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 576.5, 126.0, 261.0, 50.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 326.0, 178.0, 162.0, 36.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 634.5, 112.0, 206.0, 64.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 18.0, 234.0, 289.0, 119.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 634.5, 234.0, 244.0, 174.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 93.0, 356.0, 101.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 34.0, 404.0, 78.0, 22.0 ],
									"text" : "lg.vol.util.v01"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 34.0, 182.0, 67.0, 22.0 ],
									"text" : "lg.ping.v02"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 117.666670262813568, 456.000008523464203, 68.0, 22.0 ],
									"text" : "send~ out2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 34.0, 456.000008523464203, 68.0, 22.0 ],
									"text" : "send~ out1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "", "float", "list" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 34.0, 236.0, 48.0, 136.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 777.700005888938904, 82.400000512599945, 225.0, 255.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 742.700005888938904, 33.400000512599945, 260.0, 48.0 ],
...
, 			{
		...
		"parameters" : 		{
			"obj-2::obj-6" : [ "live.gain~[3]", "ping", 0 ],
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Desktop/Synthesis-techniques-2024/week 9/MHL-CAO-spat-boiler-master/MHL-CAO-spat-boiler-master/magnum.opus.boiler.v03/magnum.opus.boiler.v03",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
